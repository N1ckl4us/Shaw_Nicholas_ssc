...
##################################################################################################
    ...
    # Compare Rank Codes
      ...
      if final_code == authorized_final:
       ...
       print ("please enter a valid authorized code to proceed with Self destructtion.Enter confirmation code then enter either authorized_test, or authorized_final codes.")
##################################################################################################
    # Program Ends
##################################################################################################
# Self Destruct
